    ...
    init: function (app, moduleName, applicationId, userData, dataServiceUrl, showSitefiniyBox, errorMessage403) {
        ...
        this.viewModel = kendo.observable({
            ...
            showLongTextFieldEditor: function (e) {
                e.preventDefault();
                var src, value = '',
				fieldName = $(e.currentTarget).attr("data-sf-field");
                ...
                $(editorContainer).attr("data-sf-field", fieldName);
            ...
            backFromLongTextFieldEditorToEditView: function (e) {
                e.preventDefault();
                var editorContainer = $("#tabstrip-edit-longTextField").find("#editor");
                var fieldName = $(editorContainer).attr("data-sf-field");
                if (that.htmlEditor) {
            ...
            address: {
                ...
                editView: {
                    ...
                    goToAddress: function (e) {
						...
						fieldName = $(e.currentTarget).attr('data-sf-field'),
						addressContainer = $('#tabstrip-edit-address [data-sf-ftype="AddressContainer"]'),
						mapContainer = $('#tabstrip-edit-address [data-sf-ftype="AddressMap"]'),
                        ...
                        if (item && item.hasOwnProperty(fieldName)) {
                            ...
                            $('#tabstrip-edit-address-field div').attr('data-sf-field', fieldName);
                            if (!item[fieldName]) {
                ...
                showInMap: function (e) {
                    if ($(e.srcElement).is('div') || $(e.srcElement).is('img')) {
                        var fieldName = $(e.srcElement).parent().attr('data-sf-field');
                        if (fieldName) {
            ...
            image: {
                ...
                clickedImage: function (e) {
                    this.clickedImageFieldName = e.sender.element.attr('data-sf-field');
                ...
                slideShow: function (e) {
					...
					fieldName = $(e.currentTarget).parent().parent().attr('data-sf-field'),
